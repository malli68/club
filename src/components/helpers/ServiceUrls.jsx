...
const ServiceUrls = {
  ...
  USER_LOGIN: BASE_URL + "/admin/clublogin",
  ...
  CLUB_USER_REGISTRATION: BASE_URL + "/admin/userRegistration",
  GET_USER_LIST: BASE_URL + "/admin/getUserList",
  DELETE_USER_BY_ID: BASE_URL + "/admin/deleteUser",
  UPDATE_USER_BY_ID: BASE_URL + "/admin/updateUser",
  GET_USER: BASE_URL + "/admin/getUserById"
};
