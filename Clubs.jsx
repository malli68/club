...
import {setdata,adduser,getuser} from "../redux/actions/ClubsActions"
...
this.state={
    ...
    render() {
        var{name,username, email,mobile,submit_success,is_create,club_type}=this.props
                                        ...
                                        <div data-repeater-list="group-a">
                                            <div data-repeater-item class="row">
                                                <div class="form-group col-lg-2">
                                                    ...
                                                    <input type="text" value={name} id="name" name="name" class="form-control"  onChange={this.handleChange} required/>
                                                </div>

                                                <div class="form-group col-lg-2">
                                                    <label for="email">Email</label>
                                                    <input type="email" value={email}  id="email"name="email" class="form-control"  onChange={this.handleChange} required/>
                                                </div>

                                                <div class="form-group col-lg-2">
                                                    <label for="subject">Mobile</label>
                                                    <input type="text" value={mobile}  id="subject" name="mobile" class="form-control" onChange={this.handleChange} required/>
                                                </div>
                                                <div class="form-group col-lg-2">
                                                    <label for="subject">Username</label>
                                                    <input type="text" value={username} id="subject" class="form-control" name="username"   onChange={this.handleChange} required/>
                                                </div>
                                                <div class="form-group col-lg-2">
                                                    <label for="subject">Club-Types</label>
                                                    <select className="form-control" name='club_type' /* value={club_type} */ onChange={this.handleChange} required>
                                                ...
                                                <div class="col-lg-2 align-self-center">
                                                    <input data-repeater-create type="button" class="btn btn-primary btn-block" value="Create"  onClick={()=>{this.createClub ()}}></input>
                                                </div>
                                            </div>
...
<Footer/>
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      const {submit_success,is_create}=this.props  
        }
